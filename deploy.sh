...
#curl -X POST -H "Content-Type: application/json" -d '{"msg_type":"post","content":{"post":{"zh_cn":{"title":"New Update","content":[[{"tag":"a","text":"Blockie","href":"https://s.blockie.zheshi.tech/app/"},{"tag":"text","text":" has been updated."}]]}}}}' $webhookUrl