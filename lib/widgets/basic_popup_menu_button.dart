...
class BasicPopupMenuButtonController extends ChangeNotifier {
...
class BasicPopupMenuButton extends StatefulWidget {
  const BasicPopupMenuButton({
    ...
    this.controller,
    this.arrowColor = const Color(0xFFFDFDFD),
    this.showArrow = true,
  ...
  @override
  BasicPopupMenuButtonState createState() => BasicPopupMenuButtonState();
}

class BasicPopupMenuButtonState extends State<BasicPopupMenuButton> {
  RenderBox? _childBox;
  RenderBox? _parentBox;
  OverlayEntry? _overlayEntry;
  BasicPopupMenuButtonController? _controller;
            ...
            child: CustomMultiChildLayout(
              delegate: _MenuLayoutDelegate(
                ...
                anchorOffset: _childBox!.localToGlobal(
                  Offset(-widget.horizontalMargin - 49, -32),
                ),
  ...
  void initState() {
    ...
    _controller ??= BasicPopupMenuButtonController();
...
class _MenuLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    bool isTop = anchorBottomY > size.height / 2;
